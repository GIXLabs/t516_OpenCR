...
void Turtlebot3Sensor::makeMelody(uint8_t index)
{
  ...
  switch (index)
  {
    case ON:
      ...
      melody_note_[1] = NOTE_C4;   melody_duration_[1] = 4;
      melody_note_[2] = NOTE_C4;   melody_duration_[2] = 4;
      melody_note_[3] = NOTE_C4;   melody_duration_[3] = 4;
      melody_note_[4] = NOTE_C4;   melody_duration_[4] = 4;
      melody_note_[5] = NOTE_C4;   melody_duration_[5] = 4;
      melody_note_[6] = NOTE_C4;   melody_duration_[6] = 4;
      melody_note_[7] = NOTE_C5;   melody_duration_[7] = 4;
     break;

    case OFF:
      melody_note_[0] = NOTE_C5;   melody_duration_[0] = 4;
      melody_note_[1] = NOTE_C5;   melody_duration_[1] = 4;
      melody_note_[2] = NOTE_C5;   melody_duration_[2] = 4;
      melody_note_[3] = NOTE_C5;   melody_duration_[3] = 4;
      melody_note_[4] = NOTE_C5;   melody_duration_[4] = 4;
      melody_note_[5] = NOTE_C5;   melody_duration_[5] = 4;
      melody_note_[6] = NOTE_C5;   melody_duration_[6] = 4;
